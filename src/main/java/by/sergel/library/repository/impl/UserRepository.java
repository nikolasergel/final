package by.sergel.library.repository.impl;

import by.sergel.library.pool.ConnectionPool;
import by.sergel.library.entity.User;
import by.sergel.library.repository.Repository;
import by.sergel.library.repository.Specification;
...
public class UserRepository implements Repository<Integer, User> {
    ...
    public User get(Integer id) {
        ...
        try(Statement statement = connection.createStatement()){
            ...
            if(set.next()){
                ...
                user.setStatus(User.UserStatus.values()[set.getInt("status")]);//FIXME
                user.setRole(User.UserRole.values()[set.getInt("role")]);//FIXME
    ...
    //TODO 07.02.2021 16:19 Запихнуть picture to the end
    @Override
